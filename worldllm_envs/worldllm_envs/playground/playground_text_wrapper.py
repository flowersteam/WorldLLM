...
class PlayGroundText(BaseRuleEnv):  # Transformer en wrapper
    ...
    def get_test_dataset() -> List[Trajectory]:
        ...
        trajectories.append(
            Trajectory(
                [
                    "You see the baby sheep, the water, the beet seed, the baby giraffe, the water, the berry seed, the water and the berry seed. You are standing on nothing. Your are holding nothing.",
                    "You go to the water.",
                    "You are standing on the water.",
                    "You go to the baby sheep.",
                    "You are standing on the baby sheep.",
                    ...
                    "You are standing on the water.",
                    "You go to the water.",
                    "Nothing has changed, you see the baby sheep, the water, the beet seed, the baby giraffe, the water, the berry seed, the water and the berry seed.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    ...
                    "You are standing on the berry seed.",
                    "You go to the berry seed.",
                    "Nothing has changed, you see the baby sheep, the beet seed, the baby giraffe, the water, the berry seed, the water and the berry seed.",
                    "You go to the berry seed.",
                    "Nothing has changed, you see the baby sheep, the beet seed, the baby giraffe, the water, the berry seed, the water and the berry seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    ...
                    "You are standing on the berry seed.",
                    "You pick up the object.",
                    "You are holding the water and the berry seed.",
                    "You pick up the object.",
                    "Nothing has changed, you see the baby sheep, the beet, the baby giraffe, the water and the berry seed.",
                    "You pick up the object.",
                    "Nothing has changed, you see the baby sheep, the beet, the baby giraffe, the water and the berry seed.",
                ]
            )
        ...
        trajectories.append(
            Trajectory(
                [
                    "You see the baby pig, the water, the beet seed, the baby giraffe, the water, the beet seed, the water and the beet seed. You are standing on nothing. Your are holding nothing.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    ...
                    "You are standing on the beet seed.",
                    "You go to the beet seed.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the baby giraffe, the water, the beet seed, the water and the beet seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    "You pick up the object.",
                    "You are holding the water.",
                    ...
                    "You are standing on the baby pig.",
                    "You go to the beet.",
                    "You are standing on the beet.",
                    "You go to the baby pig.",
                    "You are standing on the baby pig.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    "You go to the beet seed.",
                    "Nothing has changed, you see the baby pig, the beet, the baby giraffe, the water, the beet seed, the water and the beet seed.",
                    "You go to the baby pig.",
                    "You are standing on the baby pig.",
                    "You go to the water.",
                    "You are standing on the water.",
                    ...
                    "You are holding the water.",
                    "You pick up the object.",
                    "Nothing has changed, you see the baby pig, the beet, the baby giraffe, the beet seed, the water and the beet seed.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    "You go to the beet seed.",
                    "Nothing has changed, you see the baby pig, the beet, the baby giraffe, the beet seed, the water and the beet seed.",
                    "You pick up the object.",
                    "You are holding the water and the beet seed.",
                    "You give the water.",
                    "Nothing has changed, you see the baby pig, the beet, the baby giraffe, the water and the beet seed.",
                    "You go to the beet.",
                    "You are standing on the beet.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
        ...
        trajectories.append(
            Trajectory(
                [
                    "You see the baby pig, the water, the beet seed, the baby elephant, the water, the carrot seed, the water and the pea seed. You are standing on nothing. Your are holding nothing.",
                    "You go to the water.",
                    "You are standing on the water.",
                    "You go to the water.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the baby elephant, the water, the carrot seed, the water and the pea seed.",
                    "You go to the carrot seed.",
                    "You are standing on the carrot seed.",
                    "You go to the baby elephant.",
                    "You are standing on the baby elephant.",
                    ...
                    "You are standing on the baby elephant.",
                    "You pick up the object.",
                    "You are holding the baby elephant.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    ...
                    "You are standing on the beet seed.",
                    "You go to the beet seed.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the water, the carrot seed, the water and the pea seed.",
                    "You go to the carrot seed.",
                    "You are standing on the carrot seed.",
                    "You go to the beet seed.",
                    "You are standing on the beet seed.",
                    ...
                    "You are standing on the pea seed.",
                    "You pick up the object.",
                    "You are holding the baby elephant and the pea seed.",
                    "You go to the carrot seed.",
                    "You are standing on the carrot seed.",
                    "You go to the water.",
                    "You are standing on the water.",
                    "You go to the water.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the water, the carrot seed and the water.",
                    "You pick up the object.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the water, the carrot seed and the water.",
                    "You pick up the object.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the water, the carrot seed and the water.",
                    ...
                    "You give all the objects you hold.",
                    "Nothing has changed, you see the baby pig, the water, the beet seed, the water, the carrot seed and the water.",
                    "You give the pea seed.",
                    "The pea seed and the water transform into the pea.",
                    "You go to the pea.",
                    "Nothing has changed, you see the baby pig, the beet seed, the water, the carrot seed, the water and the pea.",
                    "You go to the water.",
                    "You are standing on the water.",
                ]
            )
